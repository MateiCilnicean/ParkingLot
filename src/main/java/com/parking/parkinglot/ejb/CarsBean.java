...
public class CarsBean {
    ...
    private List<CarDto> copyCarsToDto(List<Car> cars) {
        ...
        for (Car car : cars) {
            ...
            //CarDto carDto = new CarDto(car.getId(), "fake license plate temporar", "fake parking spot", car.getOwner().getUsername());
            carDtos.add(carDto);
        }
        return carDtos;
    }
    ...
    public void createCar(String licensePlate, String parkingSpot, Long userId) {
        ...
        //the car's owner is a user, not an id, so we first need to find it using the entity manager's find method
